...
//  for file: -d @data.txt
// curl -H "Content-Type: application/json" -d '{"title": "test email", "email":"jlabrada@yahoo.com", "content":"This is a test email"}' -X POST 'localhost:3000/api/v1/tests/email'
