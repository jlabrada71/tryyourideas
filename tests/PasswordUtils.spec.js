...
-----END PUBLIC KEY-----`
  ...
  describe('passing issuer audience and subject', () => {
    ...
    const signed =  signJwt(data, { key: privateKey, passphrase: 'Ulloa%&91' }, {
      algorithm: 'RS512',
    })
  ...
  describe('expired token', () => {
    ...
    const signed =  jwt.sign(data, { key: privateKey, passphrase: 'Ulloa%&91' }, {
      algorithm: 'RS512',
    })
    ...
    it('should contain the same data', async () => {
      const verified =  jwt.verify(signed, publicKey, rightVerifyOptions )
