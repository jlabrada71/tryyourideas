<template>
  ...
  <div class="flex justify-center w-full">
    <div class="p-10 gap-10 w-4/5 flex flex-col content-center">
      <div class="flex flex-col gap-10 p-10 ">
        <span class="text-3xl flex w-full justify-center">The easiest way to create VueJS components with TailwindCSS</span>
      ...
      <div class="flex flex-col lg:flex-row justify-around gap-10 p-10 m-8 bg-slate-600 rounded-xl">
        <img class="w-1/2 object-fill" src="/assets/images/create-visually.png" alt="Create your components Visually">
        <div class="w-1/2">
      ...
      <div class="flex flex-wrap justify-around gap-10 p-10 m-10  bg-slate-100 rounded-xl">
        ...
        <img class="w-full md:w-1/2" src="/assets/images/edit-in-ide.png" alt="Then edit in your favorite ide">
      </div>

      <div class="flex flex-wrap justify-around gap-10 p-10 m-10  bg-slate-100 rounded-xl">
        <div class="w-full md:w-1/2 lg:w-1/4 bg-slate-300 rounded-xl">
          <img  class="h-1/4 w-full rounded-t-xl" src="/assets/images/gradient.png" alt="Gradient Image">
          <p class="text-3xl mx-10 my-5 font-bold">Gradients</p>
          <p class="text-xl m-10">Finding the right color combination and directions for gradients is quite time consuming. With our component editor this can be done in two mouse clicks.</p>
          <p class="text-2xl m-10"></p>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/4  bg-slate-300 rounded-xl">
          <img  class="h-1/4 w-full rounded-t-xl"  src="/assets/images/animations.png" alt="Animations image">
          <p class="text-3xl mx-10 my-5 font-bold">Animations</p>
          <p class="text-xl m-10">When you are giving life to your components, your expectation is to see how this is accomplished and quickly perfect the animation. That is what we allow with our tool. Shadows, gradients, placements and many other animations.</p>
          <p class="text-2xl m-10"></p>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/4 bg-slate-300 rounded-xl">
          <img class="h-1/4 w-full rounded-t-xl" src="/assets/images/composition.png" alt="Composition image">
          <p class="text-3xl mx-10 my-5 font-bold">Composition</p>
          <p class="text-xl m-10">There are out there many tools that offer individual components that you need to struggle with to incorporate to your design. We allow component composition in a natural way. With no hassle.</p>
          <p class="text-2xl m-10"></p>
        </div>
        <div class="w-full md:w-1/2 lg:w-1/4 bg-slate-300 rounded-xl">
          <img class="h-1/4 w-full rounded-t-xl" src="/assets/images/properties.png" alt="Properties image">
          <p class="text-3xl mx-10 my-5 font-bold">Properties</p>
          <p class="text-xl m-10">Creating properties, variables and events and orchestrating components is both, time-consuming and error prone. It's also difficult to remember which events are triggered by each component. We take care of that.</p>
          <p class="text-2xl m-10"></p>
        </div>
...
<script setup>
  ...
  const { currentUser, currentProject, accessToken, refreshToken } = useEditorStorage()
