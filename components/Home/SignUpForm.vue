  ...
  <div id="signUpForm" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div id="id-4" class=" flex flex-row flex-wrap justify-center bg-slate-100 w-80 h-96 rounded-lg ">
        <div id="id-4-1" class=" flex flex-row flex-wrap justify-end bg-inherit w-full h-10 rounded-lg ">
            <button id="id-4-1-1"  data-modal-hide="signUpForm"  type="button" class=" flex flex-row bg-inherit w-6 h-6 rounded-full hover:flex hover:flex-row hover:bg-slate-300 ">
        ...
        <input id="id-4-repeat" type="password" class=" flex flex-row bg-slate-200 w-10/12 h-9 rounded-lg border-4 border-teal-400 " placeholder="confirm password">
        <div id="id-4-6" class=" flex flex-row gap-2 bg-inherit w-10/12 h-6 ">
            <input id="id-4-6-1" type="checkbox" class=" flex flex-row bg-slate-200 w-4 h-4 "><span id="id-4-6-2" class=" flex flex-row bg-inherit w-auto h-6 text-xs ">
