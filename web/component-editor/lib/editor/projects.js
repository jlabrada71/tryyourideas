...
const PROJECT_VERSION = '0.40';

export function migrateProject(project) {
  debug('migrateProject')
  if (project.version?.startsWith(PROJECT_VERSION)) {
  ...
  project.template = project.template || 'nuxt3-tailwindcss'
...
export function getCleanProject({ name = 'Default', template = 'nuxt3-tailwindcss' }) {
  const cleanProject = {
    name: name,
