...
export function getComponentEditorClass(component, device, mode, generators = codeGenerators ) {
...
export function getComponentRenderedClass(component, generators = codeGenerators) {
