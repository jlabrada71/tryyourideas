  ...
  <div id="signInForm" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div id="id-4a" class=" flex flex-row flex-wrap gap-2 justify-center bg-slate-100 w-80 h-auto rounded-lg ">
      <div class=" flex flex-row flex-wrap justify-end bg-inherit w-full h-10 rounded-lg ">
        <button ref="closeElement" type="button" data-modal-hide="signInForm" class=" flex flex-row bg-inherit w-6 h-6 rounded-full hover:flex hover:flex-row hover:bg-slate-300 ">
      ...
      <span class=" block flex-row bg-inherit w-full h-6 text-center ">
          or
      </span>
      <input 
      ...
      <button 
        ...
        <span class=" flex flex-row bg-inherit h-6 rounded-lg font-bold ">
