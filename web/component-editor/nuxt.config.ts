  ...
  security: {
    ...
    headers: {
      contentSecurityPolicy: {
        ...
        'base-uri': ["'none'", 'http://localhost:3000', "https://tryyourideas.com", "https://www.tryyourideas.com", "https://juanlabrada.com"], // For increased security, replace by the specific sources for base URIs
